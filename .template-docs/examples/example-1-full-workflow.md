...
Tests are NOT committed during the SPECIFY phase. They remain uncommitted so that quality gates don't fail due to intentionally failing tests. The developer agent will commit tests alongside implementation during the IMPLEMENT phase.
...
* ghi9012 IMPLEMENT: Story 1 - Core widget layout (includes tests from SPECIFY phase)
